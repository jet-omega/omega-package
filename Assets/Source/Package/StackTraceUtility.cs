...
namespace Omega.Package
{
    ...
    internal static class StackTraceUtility
    {
        ...
        internal static string ExtractFormattedStackTrace(StackTrace stackTrace)
        {
            ...
            for (int index1 = 0; index1 < stackTrace.FrameCount; ++index1)
            {
                     ...
                     declaringType.Namespace != "UnityEngine"))
                {
                    ...
                    if (!string.IsNullOrEmpty(_projectFolder) && str2.Replace("\\", "/").StartsWith(_projectFolder))
                    {
                        stringBuilder.Append("Assets");
                        str2 = str2.Substring(_projectFolder.Length, str2.Length - _projectFolder.Length);
                    }
        ...
        private static void ExtractStringFromException(object exceptionObject, out string message,
